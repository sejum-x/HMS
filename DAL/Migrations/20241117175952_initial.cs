    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DosageAmount = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalBooks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DosageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicalBookId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patients", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Patients_MedicalBooks_MedicalBookId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorWorkHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorWorkHistories_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorWorkHistories_DoctorSpecializations_DoctorSpecializationId",
                        column: x => x.DoctorSpecializationId,
                        principalTable: "DoctorSpecializations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorWorkHistories_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReferralPrescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReferralPrescriptions_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReferralPrescriptions_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestPrescriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TestPrescriptions_MedicalRecords_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TreatmentPrescriptions_MedicalRecords_MedicalRecordId",
                        column: x => x.MedicalRecordId,
                        principalTable: "MedicalRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestPrescriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalTests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalTests_TestPrescriptions_TestPrescriptionId",
                        column: x => x.TestPrescriptionId,
                        principalTable: "TestPrescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Treatments_TreatmentPrescriptions_TreatmentPlanId",
                        column: x => x.TreatmentPlanId,
                        principalTable: "TreatmentPrescriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorWorkHistories_DepartmentId",
                table: "DoctorWorkHistories",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorWorkHistories_DoctorId",
                table: "DoctorWorkHistories",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorWorkHistories_DoctorSpecializationId",
                table: "DoctorWorkHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalTests_TestPrescriptionId",
                table: "MedicalTests",
                column: "TestPrescriptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_MedicalBookId",
                table: "Patients",
                column: "MedicalBookId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReferralPrescriptions_DoctorId",
                table: "ReferralPrescriptions",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_ReferralPrescriptions_MedicalRecordId",
                table: "ReferralPrescriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestPrescriptions_MedicalRecordId",
                table: "TestPrescriptions",
                column: "MedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentPrescriptions_MedicalRecordId",
